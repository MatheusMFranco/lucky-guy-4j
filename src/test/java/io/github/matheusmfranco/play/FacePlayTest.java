...
class FacePlayTest {
  ...
  void testToSides_withEnumTranslationInEnglish() {
    ...
    assertTrue(
        expectedTranslations.contains(result),
        "Result should be a translated option from the enum");
  }
  ...
  void testToSides_withEnumTranslationInPortuguese() {
    ...
    assertTrue(
        expectedTranslations.contains(result),
        "Result should be a translated option from the enum in Portuguese");
  }
}
